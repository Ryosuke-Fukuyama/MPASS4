...
RSpec.describe 'staff', type: :system do
  ...
  xdescribe 'status' do
    ...
    context 'update' do
      ...
      describe 'reverse' do
        ...
        example 'payment' do
          # click_link health_interview_1.guide_status.id
  ...
  describe 'admin' do
    ...
    describe 'patients' do
      ...
      xcontext 'show' do
        it {
          find('patient-1-healthinterviews-history').click_link
    ...
    describe 'staffs' do
      ...
      #   end
      # end
      xdescribe 'edit_staff' do
        context 'update' do
          example 'success' do
            all('tbody tr td button')[1].click_link "編集"
            fill_in 'ID',               with: 'ボブ'
      ...
      describe 'destroy' do
        ...
        #   is_expected.to have_content staff_1.name
        # end
        describe 'confirm ok' do
          # example 'admin_validation' do
          #   page.accept_confirm('削除しますか？') do
          #     click_on '削除', match: :first
          #   end
          #   is_expected.to have_content admin_staff.name
          # end
          xexample 'not admin' do
            page.accept_confirm('削除しますか？') do
              all('tbody tr td button')[1].click_link '削除'
            end
            is_expected.to have_content '削除しました'
            is_expected.not_to have_content staff_1.name
          end
  ...
  describe 'not admin' do
    ...
    xcontext 'redirect' do
      example '患者一覧開けない' do
        visit patients_path(staff_1.hospital_id)
        sleep 3.0
        expect('current_path').to eq health_interviews_path(staff_1.hospital_id)
      end
